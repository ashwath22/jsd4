...
function generateStartup() {
	...
	var randomStartupX = randomize(startupX.length);
	var randomStartupY = randomize(startupY.length);
	...
	startupIdea = "A startup that is " + startupX[randomStartupX] + ", but for " + startupY[randomStartupY] + ".";
